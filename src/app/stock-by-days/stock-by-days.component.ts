...
@Component({
  selector: 'app-stock-by-days',
  templateUrl: './stock-by-days.component.html',
  styleUrls: ['./stock-by-days.component.css']
})
export class StockByDaysComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   // this.info.aa=this.lenthgroplus();
    this.lenthgroplus();
  ...
  lenthgroplus(){
    this.gr_aplus_len=this.gr_aplus.length;
  }
  stock_gr_omoins(){
    this.paquetService.nombredepaquet("globules rouges","O-").subscribe(data=>{
      this.gr_omoins=data;
